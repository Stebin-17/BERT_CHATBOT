...
# API associated with updating the current context when user enters the content in the paragraph section to the frontend
@api_view(['POST'])
...
def upload_document(request):
    try:
        ...
        # Data pre-processing for the documents
...
def enter_url(request):
    ...
    try:
        ...
        # Limit the size of the content to 500 words.
        word_limit = 500
